...
import 'package:refactoring_todolist/section/test/views/screen/test_screen.dart';
import 'package:refactoring_todolist/common/assets_manager.dart';
...
class BottomNavigationController extends GetxController {
  ...
  List<String> navigationBarTitleList = ['할 일', '테스트'];
  ...
  @override
  void onInit() {
    navigatorKeyList = List.generate(screenWidget.length, (index) => GlobalKey<NavigatorState>());
